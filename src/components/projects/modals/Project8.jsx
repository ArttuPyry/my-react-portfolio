        ...
        <ul className="tech__info">
          ...
          <div className="project__showcase">
            <p>
              ...
              <br/>
              Watch short preview video <a href="https://youtu.be/6e0R1EBJym8?si=RK3fuO9sYBLv7_M8">here!</a>
              <br/><br/>
              The internship was fully remote, and I primarily worked as a programmer. 
              <br/><br/>
              For the game, I implemented a flying currency effect for defeated enemies using a simple object pooler. Additionally, I reworked few small features, worked on levels, final boss implementation, did some sprite work like portal, highlights and  minor fixes. I also did testing and bug fixing. 
              <br/><br/>
